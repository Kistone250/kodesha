...
<input type="text" id="myInput"onkeyup="showResult(this.value)" name="location" placeholder="Enter House location">
<input type="text"id="myInput" onkeyup="showResult(this.value)" name="amount" placeholder="Enter maximum amount">
